                    ...
                    <div class="box">
                        <form method="POST" id="form" onsubmit="return validate()">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input type="text" class="input" name="codigo" value="${producto.codigo}" readonly>
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Nombre</label>
                                <div class="control">
                                    <input type="text" class="input" name="nombre" value="${producto.nombre}" onfocusout="checkNombre()">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input type="text" class="input" name="precio" value="${producto.precio}" onfocusout="checkPrecio()">
                                    ...
                                    <div class="select is-fullwidth">
                                        <select name="categoria" onfocusout="checkCategoria()">
                                        	...
                                        	<c:forEach var="categoria" items="${categorias}">
                                                <c:choose>
                                                    <c:when test="${categoria.codigo == producto.cod_categoria}">
